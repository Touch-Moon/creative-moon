...
export const styleManual: ManualSection[] = [
  ...
  /* ── 05 SPACING ───────────────────────────────── */
  {
    ...
    description:
      ...
      'Desktop: calc(N / 1440 * 100vw) base · Tablet computed at 1024px · Mobile: calc(N / 375 * 100vw) base via :root override at ≤575.98px.',
    groups: [
      {
        label: 'Tokens',
        items: [
          { token: '--space-1',  spec: { desktopXl: '5.33px · fixed',    desktop: 'calc(4 / 1440 * 100vw) · 4px',     tablet: 'calc(4 / 1440 * 100vw) · ≈ 2.84px',   mobile: 'calc(4 / 375 * 100vw) · 4px'    } },
          { token: '--space-2',  spec: { desktopXl: '10.67px · fixed',   desktop: 'calc(8 / 1440 * 100vw) · 8px',     tablet: 'calc(8 / 1440 * 100vw) · ≈ 5.69px',   mobile: 'calc(8 / 375 * 100vw) · 8px'    } },
          { token: '--space-3',  spec: { desktopXl: '16px · fixed',      desktop: 'calc(12 / 1440 * 100vw) · 12px',   tablet: 'calc(12 / 1440 * 100vw) · ≈ 8.53px',  mobile: 'calc(12 / 375 * 100vw) · 12px'  } },
          { token: '--space-4',  spec: { desktopXl: '21.33px · fixed',   desktop: 'calc(16 / 1440 * 100vw) · 16px',   tablet: 'calc(16 / 1440 * 100vw) · ≈ 11.38px', mobile: 'calc(16 / 375 * 100vw) · 16px'  }, note: 'Base unit' },
          { token: '--space-5',  spec: { desktopXl: '26.67px · fixed',   desktop: 'calc(20 / 1440 * 100vw) · 20px',   tablet: 'calc(20 / 1440 * 100vw) · ≈ 14.22px', mobile: 'calc(20 / 375 * 100vw) · 20px'  } },
          { token: '--space-6',  spec: { desktopXl: '32px · fixed',      desktop: 'calc(24 / 1440 * 100vw) · 24px',   tablet: 'calc(24 / 1440 * 100vw) · ≈ 17.07px', mobile: 'calc(24 / 375 * 100vw) · 24px'  } },
          { token: '--space-8',  spec: { desktopXl: '42.67px · fixed',   desktop: 'calc(32 / 1440 * 100vw) · 32px',   tablet: 'calc(32 / 1440 * 100vw) · ≈ 22.76px', mobile: 'calc(32 / 375 * 100vw) · 32px'  } },
          { token: '--space-10', spec: { desktopXl: '53.33px · fixed',   desktop: 'calc(40 / 1440 * 100vw) · 40px',   tablet: 'calc(40 / 1440 * 100vw) · ≈ 28.44px', mobile: 'calc(40 / 375 * 100vw) · 40px'  } },
          { token: '--space-12', spec: { desktopXl: '64px · fixed',      desktop: 'calc(48 / 1440 * 100vw) · 48px',   tablet: 'calc(48 / 1440 * 100vw) · ≈ 34.13px', mobile: 'calc(48 / 375 * 100vw) · 48px'  } },
          { token: '--space-16', spec: { desktopXl: '85.33px · fixed',   desktop: 'calc(64 / 1440 * 100vw) · 64px',   tablet: 'calc(64 / 1440 * 100vw) · ≈ 45.51px', mobile: 'calc(64 / 375 * 100vw) · 64px'  } },
          { token: '--space-20', spec: { desktopXl: '106.67px · fixed',  desktop: 'calc(80 / 1440 * 100vw) · 80px',   tablet: 'calc(80 / 1440 * 100vw) · ≈ 56.89px', mobile: 'calc(80 / 375 * 100vw) · 80px'  } },
          { token: '--space-24', spec: { desktopXl: '128px · fixed',     desktop: 'calc(96 / 1440 * 100vw) · 96px',   tablet: 'calc(96 / 1440 * 100vw) · ≈ 68.27px', mobile: 'calc(96 / 375 * 100vw) · 96px'  } },
          { token: '--space-32', spec: { desktopXl: '170.67px · fixed',  desktop: 'calc(128 / 1440 * 100vw) · 128px', tablet: 'calc(128 / 1440 * 100vw) · ≈ 91.02px', mobile: 'calc(128 / 375 * 100vw) · 128px' } },
          { token: '--space-40', spec: { desktopXl: '213.33px · fixed',  desktop: 'calc(160 / 1440 * 100vw) · 160px', tablet: 'calc(160 / 1440 * 100vw) · ≈ 113.78px', mobile: 'calc(160 / 375 * 100vw) · 160px' } },
        ],
      },
    ],
  },
